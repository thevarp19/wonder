...
import { GetNewSignOrdersSellerContent, GetOwnOrdersPickup } from "../../types";
...
interface SellerOwnPickupOrdersTableProps {
    data: GetOwnOrdersPickup | undefined;
    isPending: boolean;
    setPage: (page: number) => void;
    page: number;
}

export const SellerOwnPickupOrdersTable: FC<
    SellerOwnPickupOrdersTableProps
