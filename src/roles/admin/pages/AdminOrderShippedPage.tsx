...
import { AdminShippedTable } from "@/modules/order/components/AdminOrders/AdminShippedTable";
import { deliveryModes, items } from "@/modules/order/const";
import { useGetShippedOrderAdmin } from "@/modules/order/queries";
...
export const AdminOrderShippedPage: FC<AdminOrderShippedPageProps> = () => {
    ...
    const { data: orders, isPending } = useGetShippedOrderAdmin(
        page,
        10,
