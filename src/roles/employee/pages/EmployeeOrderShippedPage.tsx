...
import { EmployeeShippedTable } from "@/modules/order/components/EmployeeOrders/EmployeeShippedTable";
import { deliveryModes, items } from "@/modules/order/const";
import { useGetShippedOrderEmployee } from "@/modules/order/queries";
...
interface EmployeeOrderShippedPageProps {}

export const EmployeeOrderShippedPage: FC<
    EmployeeOrderShippedPageProps
> = () => {
    ...
    const { data: orders, isPending } = useGetShippedOrderEmployee(
        page,
        10,
