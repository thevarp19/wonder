...
import { SellerAssembleTable } from "@/modules/order/components/SellerOrders/SellerAssembleTable";
import { deliveryModes, items } from "@/modules/order/const";
import { useGetAssembleOrderSeller } from "@/modules/order/queries";
...
interface SellerOrderAssemblePageProps {}

export const SellerOrderAssemblePage: FC<SellerOrderAssemblePageProps> = () => {
