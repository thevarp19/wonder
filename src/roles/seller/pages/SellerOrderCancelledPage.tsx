...
import { SellerCancelledTable } from "@/modules/order/components/SellerOrders/SellerCancelledTable";
import { deliveryModes, items } from "@/modules/order/const";
import { useGetCancelledOrderSeller } from "@/modules/order/queries";
...
> = () => {
    ...
    const { data: orders, isPending } = useGetCancelledOrderSeller(
        page,
        10,
