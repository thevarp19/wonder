    ...
    return (
        <div>
            ...
            <div className="flex gap-7 mt-5">
                <Image className="w-[100px] h-[100px]" src={profileImage} alt="profile"/>
                <div className="h-auto flex flex-col justify-center">
                    <h2 className="text-[20px] font-[600]">QIT</h2>
                    <p className="text-[16px] font-[500] text-[#4B4B4B]">ID:00101299323</p>
                </div>
            </div>
            <Button 
                style={{
            ...
            >
                <span className="underline underline-offset-[3px]">Поменять фото</span>
            </Button>
            <div className="flex md:flex-row flex-col gap-5 md:gap-10 mt-10">
                <div className="w-full md:w-1/3 flex flex-col gap-5">
                    <div>
                        ...
                        <Input
                            ...
                            disabled={!isEditing}
                            placeholder="Алишер"
                            style={{fontSize: '18px', marginTop: '8px', minWidth: "200px"}}
                        />
                    </div>
                    <div>
                        Фамилия
            ...
            {!isEditing ? (
                <Button className="md:w-[200px] w-full h-[50px] mt-12" type="primary" onClick={handleEditClick}>Редактировать</Button>
            ) : (
                <div className="flex md:flex-row flex-col gap-4 mt-12">
                    <Button className="w-full md:w-[200px]" type="primary" onClick={handleSaveClick}>Сохранить</Button>
                    <Button className="w-full md:w-[200px] h-[50px]" onClick={handleCancelClick}>Отмена</Button>
                </div>
            )}
        </div>
    );
